...
function IntelCpuScrape() {
    ...
    (async () => {
        ...
        try {
            ...
            const page = await browser.newPage();
            await page.setViewport({ width: 1366, height: 800 });
            await page.goto('https://www.amazon.co.uk/s?k=intel+cpu&crid=27RAYFWQFMVHX&sprefix=intel+cpu%2Caps%2C70&ref=nb_sb_noss_1', { waitUntil: 'load', timeout: 30000 });
            ...
            for (let i = 6; i < 20; i++) {
                ...
                cpuInfojson = JSON.stringify(cpuInfo, null, 2);
                //code not needed for now, already have test data in file
                //fs.writeFileSync("D:/Users/harry/source/repos/CodeChallenge2022/public/html/intelCpuInfo.json", cpuInfojson, "utf-8");
                console.log(cpuInfojson)
            }
        }
        catch (e) {
...
function IntelMoboScrape() {
    ...
    (async () => {
        ...
        try {
            ...
            const page = await browser.newPage();
            await page.setViewport({ width: 1366, height: 800 });
            await page.goto('https://www.amazon.co.uk/s?k=intel+motherboard&crid=24EA0FX6HSHHA&sprefix=intel+motherboar%2Caps%2C59&ref=nb_sb_noss_2', { waitUntil: 'load', timeout: 30000 });
            ...
            for (let i = 11; i < 20; i++) {
                ...
                moboInfojson = JSON.stringify(moboInfo, null, 2);
                //code not needed for now, already have test data in file
                //fs.writeFileSync("D:/Users/harry/source/repos/CodeChallenge2022/public/html/ryzenMoboInfo.json", intelInfojson, "utf-8");
                console.log(moboInfojson)
            }
        }
        catch (e) {
